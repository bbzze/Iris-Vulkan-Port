...
public class IrisChunkProgramOverrides {
	...
	private int versionCounterForTerrainShaderReload = -1;
	...
	public GlProgram<IrisChunkShaderInterface> getProgramOverride(TerrainRenderPass pass, ChunkVertexType vertexType) {
		if (versionCounterForTerrainShaderReload != Iris.getPipelineManager().getVersionCounterForTerrainShaderReload()) {
			versionCounterForTerrainShaderReload = Iris.getPipelineManager().getVersionCounterForTerrainShaderReload();
			deleteShaders();
		}
