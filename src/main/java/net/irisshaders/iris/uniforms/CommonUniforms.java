...
/**
 * Common uniforms - Vulkan Port.
 *
 * GlStateManager/GlStateManagerAccessor/BooleanStateAccessor removed.
 * Blend state and texture binding queries now use IrisRenderSystem internal tracking.
 */
public final class CommonUniforms {
	...
	public static void addDynamicUniforms(DynamicUniformHolder uniforms, FogMode fogMode) {
		...
		uniforms.uniform2i("gtextureSize", () -> {
			// Use IrisRenderSystem texture binding tracking instead of GlStateManagerAccessor
			int glId = IrisRenderSystem.getBoundTextureId(0);
		...
		uniforms.uniform4i("blendFunc", () -> {
			// Use IrisRenderSystem blend state tracking instead of GlStateManagerAccessor
			if (IrisRenderSystem.isBlendEnabled()) {
				return new Vector4i(
					IrisRenderSystem.getBlendSrcRgb(),
					IrisRenderSystem.getBlendDstRgb(),
					IrisRenderSystem.getBlendSrcAlpha(),
					IrisRenderSystem.getBlendDstAlpha());
			} else {
