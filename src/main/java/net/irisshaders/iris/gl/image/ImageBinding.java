...
/**
 * Image binding - Vulkan Port.
 *
 * GL constant inlined to remove LWJGL OpenGL dependency.
 * In Vulkan, image bindings map to storage image descriptors (Phase 8).
 */
public class ImageBinding {
	...
	public void update() {
		...
		IrisRenderSystem.bindImageTexture(imageUnit, textureID.getAsInt(), 0, true, 0, GL_READ_WRITE, internalFormat);
	}
}
