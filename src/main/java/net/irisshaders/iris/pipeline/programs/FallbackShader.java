...
public class FallbackShader extends ShaderInstance {
	...
	public FallbackShader(ResourceProvider resourceFactory, String string, VertexFormat vertexFormat,
		...
		this.gtexture = IrisRenderSystem.glGetUniformLocation(getId(), "gtexture");
		this.overlay = IrisRenderSystem.glGetUniformLocation(getId(), "overlay");
		this.lightmap = IrisRenderSystem.glGetUniformLocation(getId(), "lightmap");
	...
	public void apply() {
		...
		IrisRenderSystem.glUniform1i(gtexture, 0);
		IrisRenderSystem.glUniform1i(overlay, 1);
		IrisRenderSystem.glUniform1i(lightmap, 2);
