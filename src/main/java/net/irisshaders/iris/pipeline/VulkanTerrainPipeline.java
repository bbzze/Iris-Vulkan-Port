...
/**
 * Vulkan terrain pipeline - manages terrain shader compilation for VulkanMod.
 *
 * Replaces SodiumTerrainPipeline. Handles shader source extraction and transformation
 * for terrain solid, cutout, translucent, and shadow passes.
 */
public class VulkanTerrainPipeline {
	...
	public static String parseTerrainImport(String shader) {
	...
	public void patchShaders() {
		...
		terrainSolidSource.ifPresentOrElse(sources -> {
			...
			Map<PatchShaderType, String> transformed = TransformPatcher.patchTerrain(
				sources.getName(),
			...
			ShaderPrinter.printProgram(sources.getName() + "_terrain_solid").addSources(transformed).print();
		}, () -> {
		...
		terrainCutoutSource.ifPresentOrElse(sources -> {
			...
			ShaderPrinter.printProgram(sources.getName() + "_terrain_cutout").addSources(transformed).print();
		}, () -> {
		...
		translucentSource.ifPresentOrElse(sources -> {
			...
			ShaderPrinter.printProgram(sources.getName() + "_terrain_translucent").addSources(transformed).print();
		}, () -> {
		...
		resolver.resolve(ProgramId.Shadow).ifPresentOrElse(sources -> {
			...
			Map<PatchShaderType, String> transformed = TransformPatcher.patchTerrain(
				...
				sources.getFragmentSource().orElse(null),
				AlphaTest.ALWAYS, inputs, parent.getTextureMap());
			Map<PatchShaderType, String> transformedCutout = TransformPatcher.patchTerrain(
				sources.getName(),
				sources.getVertexSource().orElse(null),
				sources.getGeometrySource().orElse(null),
				sources.getTessControlSource().orElse(null),
			...
			ShaderPrinter.printProgram(sources.getName() + "_terrain_shadow")
				.addSources(transformed)
				.setName(sources.getName() + "_terrain_shadow_cutout")
	...
	public Optional<String> getTerrainSolidVertexShaderSource() { return terrainSolidVertex; }
	public Optional<String> getTerrainSolidGeometryShaderSource() { return terrainSolidGeometry; }
	public Optional<String> getTerrainSolidTessControlShaderSource() { return terrainSolidTessControl; }
	public Optional<String> getTerrainSolidTessEvalShaderSource() { return terrainSolidTessEval; }
	public Optional<String> getTerrainSolidFragmentShaderSource() { return terrainSolidFragment; }
	public Optional<String> getTerrainCutoutVertexShaderSource() { return terrainCutoutVertex; }
	public Optional<String> getTerrainCutoutGeometryShaderSource() { return terrainCutoutGeometry; }
	public Optional<String> getTerrainCutoutTessControlShaderSource() { return terrainCutoutTessControl; }
	public Optional<String> getTerrainCutoutTessEvalShaderSource() { return terrainCutoutTessEval; }
	public Optional<String> getTerrainCutoutFragmentShaderSource() { return terrainCutoutFragment; }
	public GlFramebuffer getTerrainSolidFramebuffer() { return terrainSolidFramebuffer; }
	public GlFramebuffer getTerrainCutoutFramebuffer() { return terrainCutoutFramebuffer; }
	public BlendModeOverride getTerrainSolidBlendOverride() { return terrainSolidBlendOverride; }
	public List<BufferBlendOverride> getTerrainSolidBufferOverrides() { return terrainSolidBufferOverrides; }
	public BlendModeOverride getTerrainCutoutBlendOverride() { return terrainCutoutBlendOverride; }
	public List<BufferBlendOverride> getTerrainCutoutBufferOverrides() { return terrainCutoutBufferOverrides; }
	public Optional<AlphaTest> getTerrainCutoutAlpha() { return terrainCutoutAlpha; }
	public Optional<String> getTranslucentVertexShaderSource() { return translucentVertex; }
	public Optional<String> getTranslucentGeometryShaderSource() { return translucentGeometry; }
	public Optional<String> getTranslucentTessControlShaderSource() { return translucentTessControl; }
	public Optional<String> getTranslucentTessEvalShaderSource() { return translucentTessEval; }
	public Optional<String> getTranslucentFragmentShaderSource() { return translucentFragment; }
	public GlFramebuffer getTranslucentFramebuffer() { return translucentFramebuffer; }
	public BlendModeOverride getTranslucentBlendOverride() { return translucentBlendOverride; }
	public List<BufferBlendOverride> getTranslucentBufferOverrides() { return translucentBufferOverrides; }
	public Optional<AlphaTest> getTranslucentAlpha() { return translucentAlpha; }
	public Optional<String> getShadowVertexShaderSource() { return shadowVertex; }
	public Optional<String> getShadowGeometryShaderSource() { return shadowGeometry; }
	public Optional<String> getShadowTessControlShaderSource() { return shadowTessControl; }
	public Optional<String> getShadowTessEvalShaderSource() { return shadowTessEval; }
	public Optional<String> getShadowFragmentShaderSource() { return shadowFragment; }
	public Optional<String> getShadowCutoutFragmentShaderSource() { return shadowCutoutFragment; }
	public GlFramebuffer getShadowFramebuffer() { return shadowFramebuffer; }
