...
public class PipelineManager {
	// GL constants (inlined from GL20C)
	...
	private int versionCounterForTerrainShaderReload = 0;
	 ...
	 * it uses version counter to check whether to reload terrain shaders.
	 ...
	 */
	public int getVersionCounterForTerrainShaderReload() {
		return versionCounterForTerrainShaderReload;
	}
	...
	public void destroyPipeline() {
		...
		pipeline = null;
		versionCounterForTerrainShaderReload++;
	}
